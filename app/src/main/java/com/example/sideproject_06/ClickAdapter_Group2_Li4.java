    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.group2_li4_btncase1:
                Vars.group2_li4_state = Vars.array_string_easeType[1];
            ...
            case R.id.group2_li4_btncase2:
                Vars.group2_li4_state = Vars.array_string_easeType[2];
            ...
            case R.id.group2_li4_btncase3:
                Vars.group2_li4_state = Vars.array_string_easeType[3];
